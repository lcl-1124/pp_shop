<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="toggleSupportShow">
    ...
    <div class="shop-header-discounts" v-if="shopInfo.supports" @click="toggleShopShow" >
        ...
        <div class="activity-sheet-content">
          ...
          <ul class="list" v-if="shopInfo.supports">
            <li class="activity-item" v-for="(support,index) in shopInfo.supports" :key="index" 
              :class="supportClasses[support.name]">
              <span class="content-tag">
...
<script>
  ...
  export default {
    data () {
      return {
        supportClasses: {'首单': 'activity-green','满减': 'activity-red','特价': 'activity-orange'},
        shopShow: false,
        supportShow: false
      }
    },
  ...
  .shop-header
    ...
    .shop-nav
      ...
      .back
        ...
        top: 10px
        left: 0
        .iconxiangyoujiantouarrowleft-copy
          display: block
          padding: 5px
          font-size: 20px
          color: #fff
