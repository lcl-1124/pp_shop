  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item activity-green" v-for="(support,index) in shopInfo.supports" 
...
<script>
  ...
  export default {
    data () {
      return {
        supportClasses: ['activity-green','activity-red','activity-orange'], // 活动种类样式
      }
    },
    computed: {
      ...mapState(['shopInfo'])
    ...
    watch: {
      shopInfo () {
        this.$nextTick(() => { // 在下次 DOM 更新循环结束之后执行延迟回调 (异步)
          this.setScroll()
        })
      }
    }
