...
<script>
  ...
  export default {
    data () {
      return {
        keyword: '',  // 输入关键字
        baseImgUrl: 'http://cangdu.org:8001/img/', // 基础地址
    ...
    watch: {
      searchShops (value) {
        if (!value.length) { // 没有搜索结果
          this.noSearchShops = true;
        } else {  // 有结果，更新noSearchShops状态为false
